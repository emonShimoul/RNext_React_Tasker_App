  ...
  return (
    <>
      ...
      <form
        ...
        className="my-10 w-full max-w-185 rounded-xl border border-[#FEFBFB]/36 bg-[#191D26] p-9 max-md:px-4 lg:my-20 lg:p-11 z-10 absolute top-1/4 left-1/2 -translate-x-1/2"
      >
